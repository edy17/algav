...
public class DefaultTeam {
    ...
    //    Lemme 1 : si un cercle de diamètre égale à la distance de deux points
    //    de la liste couvre tout autre point de la liste, alors ce cercle est un
    //    cercle couvrant de rayon minimum

    //    Lemme 2 : en 2D, il existe un et un seul cercle passant par 3 points
    //    non-colinéaires.
